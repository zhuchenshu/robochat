...
3)  开发环境与工具：Tomcat服务器、git代码管理系统、vue-cli 3.x框架、node.js框架，Chrome浏览器、idea集成开发器。
4)  参考技术资料：《spring实战》
...
前端：node.js 6.x, vue-cli 3.x


### 2.3 开发环境

Sublime Text+Eclipse，node.js 8.9+ +vue-cli 3.x+浏览器
git代码管理系统
...
![流程图](https://img-blog.csdnimg.cn/20190806112638136.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MjA0MzgzOQ==,size_16,color_FFFFFF,t_70)
...
=======
   ![聊天界面](../img/聊天界面.png)
>>>>>>> 594bd2d9853ea18124f08c65442901c147612e24
